...
from ingresso_dataclasses.parser.core import _is_supported_generic
from ingresso_dataclasses.parser.utils import (_is_collection, _is_mapping,
...
class _DecimalField(fields.Field):
    def _serialize(self, value, attr, obj, **kwargs):
        return float(value)
